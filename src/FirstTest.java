...
public class FirstTest {
    ...
    public void tearDown() {
        // В этом блоке осуществляется восстановление экрана в портретное положение
        try {
            // Восстановление экрана в портретное положение
        } catch (Exception e) {
            // Обработка ошибки, если что-то пошло не так при восстановлении
        } finally {
